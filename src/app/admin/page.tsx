      ...
      const mockProducts: Product[] = [
        {
          ...
          price: 1.50,
          category: 'groceries',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Fresh+Milk',
          stock: 20,
          isActive: true,
        },
        {
          ...
          price: 2.50,
          category: 'groceries',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Free+Range+Eggs',
          stock: 15,
          isActive: true,
        },
        {
          ...
          price: 3.00,
          category: 'groceries',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Artisan+Bread',
          stock: 8,
          isActive: true,
        },
        {
          ...
          price: 4.50,
          category: 'groceries',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Local+Honey',
          stock: 12,
          isActive: true,
        },
        {
          ...
          price: 8.00,
          category: 'groceries',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Organic+Vegetables',
          stock: 5,
          isActive: true,
        },
        {
          ...
          price: 12.00,
          category: 'gifts',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Lake+District+Mug',
          stock: 25,
          isActive: true,
        },
        {
          ...
          price: 15.00,
          category: 'gifts',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Handmade+Soap',
          stock: 10,
          isActive: true,
        },
        {
          ...
          price: 35.00,
          category: 'gifts',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Cumbrian+Whisky',
          stock: 8,
          isActive: true,
        },
        {
          ...
          price: 18.00,
          category: 'gifts',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Guide+Book',
          stock: 15,
          isActive: true,
        },
        {
          ...
          price: 3.50,
          category: 'essentials',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Toilet+Paper',
          stock: 30,
          isActive: true,
        },
        {
          ...
          price: 4.00,
          category: 'essentials',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=Shower+Gel',
          stock: 20,
          isActive: true,
        },
        {
          ...
          price: 12.50,
          category: 'essentials',
          image: 'https://via.placeholder.com/300x200/4ade80/ffffff?text=First+Aid+Kit',
          stock: 8,
          isActive: true,
        },
      ];
